...
<html>
    <head>
        ...
        <title><?php echo $fieldinfo -> MovieName ?></title>
        <script>
        ...
        <nav class = "navbar navbar-expand p-3 pb-0 justify-content-between" style="height:10vh;background-color:black;width:100%">
            ...
            <div class = "collapse navbar-collapse" style="height:100%;">
                <ul class = "navbar-nav h-100" style="font-size:18px;position:relative;bottom:-30%;">
                    <li class = "nav-item" >
                        <a class = "nav-link active fw-bold text-white" href="">Home</a>
                    </li>
                    <li class = "nav-item">
                        <a class = "nav-link text-white" href="">Buy ticket</a>
                    </li>
                    <li class = "nav-item dropdown">
                        ...
                        <ul class = "dropdown-menu" aria-labelledby="LandMore">
                            <li><a class = "dropdown-item " href="">View Movie</a></li>
                            <li><a class ="dropdown-item" href="">Login</a></li>
                        </ul>
                    </li>
                </ul>
                <a href = "#" class="nav-item btn btn-light rounded-3 p-2 px-4 py-2 h5 fw-bold text-dark link-underline link-underline-opacity-0" style="position:relative;left:67%;bottom:-10%">Login</a>
            </div>
        </nav>
            ...
            <div class="container-fluid d-flex row px-0 mt-5" style="height:auto;">
                ...
                while ($row = mysqli_fetch_row($result))
                {
                    ...
                    <div class='col-4 py-4 d-flex flex-column align-items-center justify-content-center'>
                        <div><a id='$row[0]' onclick='selectMovie(this.id)'><img class = 'ms-3 rounded-4' src= './New folder/Poster$row[0].jpg' style='cursor: pointer;height:60vh;width:20vw;object-fit:contain;box-shadow:0 0px 50px 3px #D8D9DA;'></div></a>
                        <div class ='mt-3 text-warning text-center fw-bold h5'>$fieldinfo -> moviename</div>
